...
int main() {
	...
	printf("Spoofing/Deleting Registry Key traces.");
	// Monitors
	...
	*/
	...
	system("cls");
	printf("Registry spoofing done.");
	printf("Spoofing/Deleting tracking files from system.");
	system("TIMEOUT /T 3");
	...
	system("cls");
	printf("Tracking files done.");
	printf("Last steps are beeing done now...");
	printf("Reseting WMIC because it holds cache of SMBIOS");
	system("TIMEOUT /T 3");;
